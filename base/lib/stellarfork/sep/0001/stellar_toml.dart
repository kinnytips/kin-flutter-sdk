...
class StellarToml {
  ...
  late List<PointOfContact> pointsOfContact;
  ...
  static Currency _currencyFromItem(var item) {
    ...
    if (collateralAddresses != null) {
      currency.collateralAddresses = <String>[];
    ...
    if (collateralAddressMessages != null) {
      currency.collateralAddressMessages = <String>[];
    ...
    if (collateralAddressSignatures != null) {
      currency.collateralAddressSignatures = <String>[];
...
class Currency {
  ...
  late List<String> collateralAddressSignatures;
