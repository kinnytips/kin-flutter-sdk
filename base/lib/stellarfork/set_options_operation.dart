...
class SetOptionsOperation extends Operation {
  ...
  XdrOperationBody toOperationBody() {
    ...
    if (clearFlags != null) {
      XdrUint32 clearFlags = new XdrUint32(this.clearFlags!);
      op.clearFlags = clearFlags;
    }
    if (setFlags != null) {
      XdrUint32 setFlags = new XdrUint32(this.setFlags!);
      op.setFlags = setFlags;
    }
    if (masterKeyWeight != null) {
      XdrUint32 uint32 = new XdrUint32(masterKeyWeight!);
      op.masterWeight = uint32;
    }
    if (lowThreshold != null) {
      XdrUint32 uint32 = new XdrUint32(lowThreshold!);
      op.lowThreshold = uint32;
    }
    if (mediumThreshold != null) {
      XdrUint32 uint32 = new XdrUint32(mediumThreshold!);
      op.medThreshold = uint32;
    }
    if (highThreshold != null) {
      XdrUint32 uint32 = new XdrUint32(highThreshold!);
      op.highThreshold = uint32;
    }
    if (homeDomain != null) {
      XdrString32 homeDomain = new XdrString32(this.homeDomain!);
