...
class SubmitTransactionResponse_Result extends $pb.ProtobufEnum {
  ...
  static const SubmitTransactionResponse_Result FAILED = SubmitTransactionResponse_Result._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FAILED');
  static const SubmitTransactionResponse_Result REJECTED = SubmitTransactionResponse_Result._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REJECTED');
  static const SubmitTransactionResponse_Result INVOICE_ERROR = SubmitTransactionResponse_Result._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INVOICE_ERROR');
  static const SubmitTransactionResponse_Result PAYER_REQUIRED = SubmitTransactionResponse_Result._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYER_REQUIRED');
...
class GetTransactionResponse_State extends $pb.ProtobufEnum {
  ...
  static const GetTransactionResponse_State FAILED = GetTransactionResponse_State._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FAILED');
  static const GetTransactionResponse_State PENDING = GetTransactionResponse_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PENDING');
