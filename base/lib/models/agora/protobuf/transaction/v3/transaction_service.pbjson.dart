...
const SubmitTransactionResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'invoice_errors', '3': 2, '4': 3, '5': 11, '6': '.kin.agora.common.v3.InvoiceError', '10': 'invoiceErrors'},
...
final $typed_data.Uint8List submitTransactionResponseDescriptor = $convert.base64Decode('');
